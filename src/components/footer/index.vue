    ...
    <div class="footer-content">
      <div class="footer-link clearfix">
        ...
        <div class="footer-column">
          ...
          <dl>
            <dt>知识产权</dt>
            <dd><a rel="nofollow" href="https://ipr.meituan.com" target="_blank">知识产权维权平台</a></dd>
          </dl>
        </div>
        <div class="footer-column">
          <dl>
      ...
      <div class="footer-copyright clearfix">
        <div class="footer-copyright-left"><p>©美团网团购 meituan.com<a href="http://www.beian.miit.gov.cn/"
          ...
          <p><a href="https://portal-portm.meituan.com/webpc/protocolmanage/medicalequipment" target="_blank">医疗器械网络交易服务第三方平台备案：（京）网械平台备字[2018]第00004号</a>
          </p></div>
...
<style lang="scss">
  @import "src/assets/css/public/footer";
</style>
